...
def get_paml_paths(username="miltr339"):
    ...
    tables = {
        "A" : {
            ...
            "dNdS" : f"/Users/{username}/work/PhD_code/PhD_chapter3/data/DE_analysis/paml_summary_tables/dNdS_by_A_ortholog_pairwise_revisions.txt",
        ...
        "X" : {
            ...
            "dNdS" : f"/Users/{username}/work/PhD_code/PhD_chapter3/data/DE_analysis/paml_summary_tables/dNdS_by_X_ortholog_pairwise_revisions.txt",
