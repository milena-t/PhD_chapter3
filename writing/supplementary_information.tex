...
\begin{table}[H]
    \centering
    \caption{Permutation test results (n=10000) for all pairwise species comparisons.}
    \label{SItab:BUSCO}
    \begin{tabular}{l | l | c |c | c}
        species 1  & species 2 & measured dS$_A$-dS$_X$ & permutation test dS$_A$-dS$_X$ and CI & significance \\
        \hline
        \hline	 
        \textit{A. obtectus} & \textit{C. maculatus} & 0.098 &  0.00014 with CI [-0.03081,0.03110] & SIGNIFICANT \\
        \hline
        \textit{C. chinensis} & \textit{C. maculatus} & 0.050 &  0.00019 with CI [-0.01798,0.01836] & SIGNIFICANT \\
        \hline
        \textit{B. siliquastri} & \textit{C. maculatus} & 0.120 &  0.00004 with CI [-0.02476,0.02484] & SIGNIFICANT \\
        \hline
        \textit{A. obtectus} & \textit{C. chinensis} & 0.072 &  0.00009 with CI [-0.03635,0.03653] & SIGNIFICANT \\
        \hline
        \textit{A. obtectus} & \textit{B. siliquastri} & 0.093 & -0.00010 with CI [-0.02889,0.02868] & SIGNIFICANT \\
        \hline
        \textit{B. siliquastri} & \textit{C. chinensis} & 0.097 & -0.00001 with CI [-0.02696,0.02695] & SIGNIFICANT \\
        \hline
        \textit{C. magnifica} & \textit{C. septempunctata} & 0.048 & -0.00007 with CI [-0.01728,0.01715] & SIGNIFICANT \\
        \hline
        \textit{T. castaneum} & \textit{T. freemani} & -0.002 & 0.00002 with CI [-0.01600,0.01603] & (nonsignificant) \\
        \hline
    \end{tabular}
\end{table}
