...
\begin{figure}[H]
    ...
    We are utilizing the log2 fold change (og2LFC) information from genes in \textit{C. maculatus} and combining it with d$_N$/d$_S$ between these genes 
    and their 1-to-1 orthologs in other bruchids. The log2FC contrast is always female-male,therefore positive values indicate female-bias and negative values indicate male-bias.
