...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.32\textwidth}
        \llap{\hspace{20pt}\textbf{A}}%
            \includegraphics[width=0.95\textwidth]{../data/DE_analysis/dNdS_vs_conservation_rank_all_comparisons.png}
    \end{minipage}%
    \begin{minipage}[t]{0.67\textwidth}
        \llap{\hspace{20pt}\textbf{B}}%
            \includegraphics[width=0.205\textwidth]{../data/DE_analysis/dNdS_merged_conservation_rank_boxplot_abdomen.png}
