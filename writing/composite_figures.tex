...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.67\textwidth}
        \vspace{0pt}
        \begin{overpic}[width=0.205\textwidth]{../data/DE_analysis/dNdS_merged_conservation_rank_boxplot_abdomen.png}
            \put(5,98){\textbf{B}}
        \end{overpic}
            \includegraphics[width=0.205\textwidth]{../data/DE_analysis/dNdS_merged_conservation_rank_boxplot_head_thorax.png}
            \includegraphics[width=0.275\textwidth]{../data/DE_analysis/pos_sel_merged_conservation_rank_boxplot_abdomen.png}
            \includegraphics[width=0.275\textwidth]{../data/DE_analysis/pos_sel_merged_conservation_rank_boxplot_head_thorax.png}
    \end{minipage}
