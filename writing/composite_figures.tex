...
\begin{figure}[H]
    ...
    \begin{minipage}[t]{0.5\textwidth}
        \llap{\hspace{20pt}\textbf{A}}%
            \includegraphics[width=0.75\textwidth]{../data/DE_analysis/dNdS_vs_conservation_rank_all_comparisons.png}
    \end{minipage}%
    \begin{minipage}[t]{0.48\textwidth}
        \llap{\hspace{20pt}\textbf{B}}%
            \includegraphics[width=0.4\textwidth]{../data/DE_analysis/dNdS_merged_conservation_rank_boxplot_abdomen.png}
            \includegraphics[width=0.4\textwidth]{../data/DE_analysis/dNdS_merged_conservation_rank_boxplot_head_thorax.png}
    \end{minipage}
