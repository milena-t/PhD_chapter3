...
cwd=$(pwd)
# for FILE in /proj/coleoptera-genomics-2025/snic2021-6-30/Milena/chapter3/revision/site_model_bruchini/bruchini_fasta_A/*.fasta # or bruchini_seqs_revision_X
