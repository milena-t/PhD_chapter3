...
if [ -d $LIBRARIES_DIR ]; then
  ...
  ## To recover a failed/timeout run, use: 
  # -recoverDir path/to/RM_[...timestamp...]
  # and comment out the test for if $LIBRARIES_DIR exists, jump directly to repeatmodeller in any case
