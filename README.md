...
Wald p-value: p=0.34 -> interaction not significant!
...
===============================================================================================================
wald test for 'C(chromosome)[T.X]:level_most_dist_ortholog = 0' interaction: Wald test (chi2): statistic=0.9223215746168589, p-value=0.3368661400409069, df_denom=1
```

##### `chromosome + conservation_distance`

Wald p-value: p=0.08 -> major effect conservation distance borderline nonsignificant
...
============================================================================================
                               coef    std err          z      P>|z|      [0.025      0.975]
--------------------------------------------------------------------------------------------
Intercept                   -1.5476      0.138    -11.216      0.000      -1.818      -1.277
C(chromosome)[T.X]           0.5859      0.136      4.299      0.000       0.319       0.853
level_most_dist_ortholog    -0.0538      0.031     -1.749      0.080      -0.114       0.007
============================================================================================
wald test for 'level_most_dist_ortholog = 0' major effect: Wald test (chi2): statistic=3.0576717772512727, p-value=0.0803567331086158, df_denom=1
```
...
Wald-test p-value: p=0.20 -> interaction not significant
...
===============================================================================================================
wald test for 'C(chromosome)[T.X]:level_most_dist_ortholog = 0' interaction: Wald test (chi2): statistic=1.6589472728806682, p-value=0.19774552091095293, df_denom=1
```

##### `chromosome + conservation_distance`

Wald p-value: p=0.95 -> conservation distance not significant
...
============================================================================================
                               coef    std err          z      P>|z|      [0.025      0.975]
--------------------------------------------------------------------------------------------
Intercept                   -2.4553      0.214    -11.466      0.000      -2.875      -2.036
C(chromosome)[T.X]           0.4100      0.164      2.505      0.012       0.089       0.731
level_most_dist_ortholog     0.0030      0.047      0.064      0.949      -0.089       0.095
============================================================================================
wald test for 'level_most_dist_ortholog = 0' major effect: Wald test (chi2): statistic=0.004051202575329492, p-value=0.949249668325261, df_denom=1
```
...
Wald p-value: p=0.87 -> interaction not significant
...
===============================================================================================================
wald test for 'C(chromosome)[T.X]:level_most_dist_ortholog = 0' interaction: Wald test (chi2): statistic=0.026525884904183138, p-value=0.8706226096471719, df_denom=1
```

##### `chromosome + conservation_distance`

Wald p-value: p=0.16 -> conservation distance not significant
...
============================================================================================
                               coef    std err          z      P>|z|      [0.025      0.975]
--------------------------------------------------------------------------------------------
Intercept                   -3.5618      0.330    -10.787      0.000      -4.209      -2.915
C(chromosome)[T.X]           0.6989      0.190      3.678      0.000       0.326       1.071
level_most_dist_ortholog     0.1000      0.072      1.390      0.164      -0.041       0.241
============================================================================================
wald test for 'level_most_dist_ortholog = 0' major effect: Wald test (chi2): statistic=1.933342940963474, p-value=0.16439317392797437, df_denom=1
```
...
Before connecting this to dNdS and positive selection, I will see how sex bias changes with more or less conserved genes
...
* Sex bias is lower in somatic than reproductive
  * older genes are more female-biased and younger genes are more male-biased
  * somatic: A is more male-biased than X
* younger genes become more male biased on A than on X
...
==================================================================================================================
                                                     coef    std err          t      P>|t|      [0.025      0.975]
------------------------------------------------------------------------------------------------------------------
Intercept                                          3.6587      0.046     79.059      0.000       3.568       3.749
C(SB_abdomen)[T.male]                             -2.9382      0.114    -25.823      0.000      -3.161      -2.715
level_most_dist_ortholog                          -0.3926      0.011    -37.209      0.000      -0.413      -0.372
level_most_dist_ortholog:C(SB_abdomen)[T.male]     0.3715      0.024     15.335      0.000       0.324       0.419
==================================================================================================================
...
======================================================================================================================
                                                         coef    std err          t      P>|t|      [0.025      0.975]
----------------------------------------------------------------------------------------------------------------------
Intercept                                              5.2101      0.045    115.975      0.000       5.122       5.298
C(SB_head_thorax)[T.male]                             -4.3811      0.070    -63.022      0.000      -4.517      -4.245
level_most_dist_ortholog                              -0.7485      0.011    -69.164      0.000      -0.770      -0.727
level_most_dist_ortholog:C(SB_head_thorax)[T.male]     0.6839      0.016     43.650      0.000       0.653       0.715
======================================================================================================================
```
...
==================================================================================================================
                                                     coef    std err          t      P>|t|      [0.025      0.975]
------------------------------------------------------------------------------------------------------------------
Intercept                                          3.7554      0.287     13.096      0.000       3.191       4.320
C(SB_abdomen)[T.male]                             -3.1135      0.534     -5.834      0.000      -4.164      -2.063
level_most_dist_ortholog                          -0.3845      0.061     -6.308      0.000      -0.504      -0.264
level_most_dist_ortholog:C(SB_abdomen)[T.male]     0.3753      0.111      3.390      0.001       0.157       0.593
==================================================================================================================
...
======================================================================================================================
                                                         coef    std err          t      P>|t|      [0.025      0.975]
----------------------------------------------------------------------------------------------------------------------
Intercept                                              4.1194      0.371     11.089      0.000       3.386       4.853
C(SB_head_thorax)[T.male]                             -3.2497      0.499     -6.507      0.000      -4.236      -2.264
level_most_dist_ortholog                              -0.5512      0.080     -6.863      0.000      -0.710      -0.393
level_most_dist_ortholog:C(SB_head_thorax)[T.male]     0.4860      0.106      4.604      0.000       0.278       0.694
======================================================================================================================
```
...
=========================================================================================================================================
-------------> no age rank to isolate sex bias effect
================================================================================================================
                                                     coef    std err          z      P>|z|      [0.025      0.975]
----------------------------------------------------------------------------------------------------------------
* Intercept                                       -1.7425      0.063    -27.748      0.000      -1.866      -1.619
  C(SB_abdomen)[T.male]                            0.0763      0.086      0.884      0.377      -0.093       0.245
  C(SB_abdomen)[T.unbiased]                       -0.1182      0.076     -1.552      0.121      -0.267       0.031
  C(chromosome)[T.X]                               0.0842      0.321      0.262      0.793      -0.545       0.714
  C(SB_abdomen)[T.male]:C(chromosome)[T.X]         0.5321      0.451      1.181      0.238      -0.351       1.415
  C(SB_abdomen)[T.unbiased]:C(chromosome)[T.X]     0.6572      0.364      1.804      0.071      -0.057       1.371
================================================================================================================
...
====================================================================================================================
                                                       coef    std err          z      P>|z|      [0.025      0.975]
--------------------------------------------------------------------------------------------------------------------
* Intercept                                           -1.5576      0.115    -13.504      0.000      -1.784      -1.331
. C(SB_head_thorax)[T.male]                           -0.2815      0.152     -1.848      0.065      -0.580       0.017
* C(SB_head_thorax)[T.unbiased]                       -0.2375      0.120     -1.978      0.048      -0.473      -0.002
  C(chromosome)[T.X]                                  -1.0074      1.044     -0.965      0.335      -3.054       1.039
  C(SB_head_thorax)[T.male]:C(chromosome)[T.X]         1.6833      1.167      1.442      0.149      -0.605       3.971
  C(SB_head_thorax)[T.unbiased]:C(chromosome)[T.X]     1.6238      1.054      1.541      0.123      -0.442       3.689
====================================================================================================================
...
<p float="left">
  ...
  <img src="data/DE_analysis/pos_sel_merged_conservation_rank_boxplot_abdomen_white_bg.png" width="25%" />
  <img src="data/DE_analysis/pos_sel_vs_conservation_rank_boxplot_head_thorax_white_bg.png" width="74%" />
